...
if __name__ == "__main__":
    ...
    for num_neuron in range(6, 7):
        ...
        # if num_neuron > 1:
        #     model_tmp = torch.load('../Models/' + file_name + '_GNAS-CVCNN_Tanh_' + str(num_neuron - 1) + '.pth')
        ...
        scio.savemat('../DataSave/' + file_name + '_GNAS-CVCNN_Tanh_' + str(num_neuron) + '.mat', dict)
        torch.save(model, '../Models/' + file_name + '_GNAS-CVCNN_Tanh_' + str(num_neuron) + '.pth')
